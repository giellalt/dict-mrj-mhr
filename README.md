# Dictionary for mrj — mhr

This repository contains source files for a dictionary from Western Mari to Eastern Mari. The content is licensed under the CC-BY-4.0 license.
